...
----
include::aerospace-center-floating-window.adoc[tags=synopsis]
----
include::aerospace-center-floating-window.adoc[tags=purpose]
include::aerospace-center-floating-window.adoc[tags=body]
...
== echo
----
include::aerospace-echo.adoc[tags=synopsis]
----
include::aerospace-echo.adoc[tags=purpose]
include::aerospace-echo.adoc[tags=body]
...
----
include::aerospace-eval.adoc[tags=purpose]
include::aerospace-eval.adoc[tags=body]
...
== false
----
include::aerospace-false.adoc[tags=synopsis]
----
include::aerospace-false.adoc[tags=purpose]
include::aerospace-false.adoc[tags=body]
...
== notifications
----
include::aerospace-notifications.adoc[tags=synopsis]
----
include::aerospace-notifications.adoc[tags=purpose]
include::aerospace-notifications.adoc[tags=body]
...
== run-callback
----
include::aerospace-run-callback.adoc[tags=synopsis]
----
...
== test
----
include::aerospace-test.adoc[tags=synopsis]
----
include::aerospace-test.adoc[tags=purpose]
include::aerospace-test.adoc[tags=body]

== test-not
----
include::aerospace-test-not.adoc[tags=synopsis]
----
include::aerospace-test-not.adoc[tags=purpose]
include::aerospace-test-not.adoc[tags=body]
...
== true
----
include::aerospace-true.adoc[tags=synopsis]
----
include::aerospace-true.adoc[tags=purpose]
include::aerospace-true.adoc[tags=body]
